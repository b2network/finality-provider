...
func NewQuery(cfg *config.FGConfig, db db.IDatabaseHandler, logger *zap.Logger) (*Query, error) {
 ...
 */
func (fg *Query) QueryIsBlockBabylonFinalized(block *types.Block) (bool, error) {
...
func (fg *Query) QueryBtcStakingActivatedTimestamp() (uint64, error) {
...
func (fg *Query) queryBtcStakingActivationTimestamp() (uint64, error) {
	allFpPks, err := fg.queryAllFpBtcPubKeys()
	if err != nil {
		return math.MaxUint64, err
	}
...
func (fg *Query) queryAllFpBtcPubKeys() ([]string, error) {
	// get the consumer chain id
...
func (fg *Query) MonitorBtcStakingActivation(ctx context.Context) {
